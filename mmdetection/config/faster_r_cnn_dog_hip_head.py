...
data_root = '/home/featurize/work/data/Test/'
...
val_evaluator = [
    dict(type='CocoMetric',ann_file=data_root + 'cocoLabels_head.json',metric='bbox',format_only=False, backend_args=backend_args), 

...
metainfo = {'classes': ('cranial acetabulum','center')}
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        metainfo=metainfo,
        ann_file='cocoLabels_AC_FH.json',
...
val_evaluator = [
    dict(type='CocoMetric',ann_file=valid_data_root + 'cocoLabels_AC_FH.json',metric='bbox',format_only=False, backend_args=backend_args), 

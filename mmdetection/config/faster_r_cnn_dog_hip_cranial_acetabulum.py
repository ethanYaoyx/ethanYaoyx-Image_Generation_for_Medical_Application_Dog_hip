...
metainfo = {'classes': ('cranial acetabulum',)}
...
val_evaluator = [
    dict(type='CocoMetric',ann_file=valid_data_root + 'cocoLabels_cranial_acetabulum.json',metric='bbox',format_only=False, backend_args=backend_args), 

...
from .loss_combined import BCEKLDCombinedLoss
from .loss_combined import KLDMAECombinedLoss
__all__ = [
    ...
    'AssociativeEmbeddingLoss', 'SoftWeightSmoothL1Loss','BCEKLDCombinedLoss','KLDMAECombinedLoss'
]

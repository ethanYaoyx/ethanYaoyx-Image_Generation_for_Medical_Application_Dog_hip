...
# 关键点检测数据集-元数据
dataset_info = {
    'dataset_name':'dog_hip_CA',
    'classes': 'cranial acetabulum',
    'paper_info': {
        'author':'Yuxiao Yao',
    ...
    'keypoint_info': {
        0: {'name': 'left', 'id': 0, 'color': [255, 0, 0], 'type': '', 'swap': ''},
        1: {'name': 'right', 'id': 1, 'color': [0, 255, 0], 'type': '', 'swap': ''}
    },
    'skeleton_info': {}
}
# dataset_info = {
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_mode=data_mode,
        ann_file='cocoLabels_cranial_acetabulum.json',
...
# evaluators
val_evaluator = [
    dict(type='CocoMetric', ann_file=valid_data_root + 'cocoLabels_cranial_acetabulum.json'),
